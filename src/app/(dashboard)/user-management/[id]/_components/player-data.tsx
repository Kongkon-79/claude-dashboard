      ...
      <div className='bg-white shadow[0px_4px_16px_0px_#00000029] rounded-[16px] grid grid-cols-1 md:grid-cols-5 gap-10 p-6 border'>
        ...
        <div className="md:col-span-4">
          <ul className="grid gris-cols-1 md:gris-cols-2 lg:grid-cols-4 gap-6">
            ...
            <li className="flex flex-col gap-2"><span className='text-base font-medium text-[#616161] leading-[150%]'>Nationality</span> <span className='text-lg md:text-xl text-[#131313] font-medium leading-[120%] '>{data?.nationality || "N/A"}</span></li>
            ...
            <li className="flex flex-col gap-2"><span className='text-base font-medium text-[#616161] leading-[150%]'>Gender</span> <span className='text-lg md:text-xl text-[#131313] font-medium leading-[120%] '>{data?.gender || "N/A"}</span></li>
             <li className="flex flex-col gap-2"><span className='text-base font-medium text-[#616161] leading-[150%]'>Citizenship</span> <span className='text-lg md:text-xl text-[#131313] font-medium leading-[120%] '>{data?.citizenship || "N/A"}</span></li>
